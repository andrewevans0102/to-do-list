...
- This project also uses a custom script for code coverage, if you run `npm run coverage-report` it will use Angulars code coverage report to show you how well the unit tests are covering the project
